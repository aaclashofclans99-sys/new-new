...
export function initExpertiseSlider() {
  ...
  // Setup dots based on original slide count
  ...
  const updatePosition = (animate = true) => {
    ...
    // Position using percentages to ensure no gaps regardless of screen resize
  ...
  // Intersection Observer to start auto-slide only when visible
  ...
  const handleTouchEnd = (e) => {
    ...
    // Re-start auto-slide after manual interaction if still in view
    startAutoSlide();
  };
